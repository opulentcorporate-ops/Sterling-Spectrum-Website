        ...
        <div className="cta-content">
          <div className="cta-main">
            <div className="cta-text">
              ...
              <p>
                Join hundreds of satisfied clients who trust Sterling Spectrum for all their 
                corporate supply needs. Get started today with a personalized consultation 
              ...
              <div className="cta-stats">
                ...
                <div className="stat-item">
                  <div className="stat-number">GEM</div>
          ...
          <div className="cta-features">
            <div className="feature-card">
              ...
              <p>Only the finest products and services for your business needs</p>
            </div>
            <div className="feature-card">
              <div className="feature-icon">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
              ...
              <h3>Fast Delivery</h3>
              <p>Quick and reliable delivery to keep your operations running</p>
            </div>
            <div className="feature-card">
              <div className="feature-icon">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
              ...
              <p>GEM registered with government compliance and security standards</p>
            </div>
          </div>
        </div>
      </div>
